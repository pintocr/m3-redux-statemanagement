...
import './index.css';
import App, { IProductData, IProductAction } from './App';
...
ReactDOM.render(<App stateCounter={window.CS.getUIState().counter} sumOfAmount={window.CS.getBMState().sumOfAmount} sumOfTotalPrice={window.CS.getBMState().sumOfTotalPrice} isLoggedIn = {window.CS.getBMState().isloggedIn} />, document.getElementById('root'));
